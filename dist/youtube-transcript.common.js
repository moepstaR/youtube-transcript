'use strict';var fetch=require('node-fetch'),HttpsProxyAgent=require('https-proxy-agent');const RE_YOUTUBE = /(?:youtube\.com\/(?:[^\/]+\/.+\/|(?:v|e(?:mbed)?)\/|.*[?&]v=)|youtu\.be\/)([^"&?\/\s]{11})/i;
...
class YoutubeTranscript {
    ...
    static async fetchTranscript(videoId, config) {
        ...
        const transcriptURL = (config?.lang
